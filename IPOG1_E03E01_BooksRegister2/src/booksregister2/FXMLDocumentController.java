...
public class FXMLDocumentController implements Initializable {
    ...
    @FXML
    private FasterSpinner<EnumGenre> fasterSpinnerGenre;
    @FXML
    private FasterSpinner<Integer> fasterSpinnerQuantity;
    @FXML
    private FasterSpinner<Integer> fasterSpinnerPrize;
    @FXML
     ...
     * {@link #fasterSpinnerGenre}, {@link #fasterSpinnerQuantity} a {@link #fasterSpinnerPrize}
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        this.fasterSpinnerGenre.setValueFactory(
                new ListSpinnerValueFactory(
                        FXCollections.observableArrayList(EnumGenre.values())
                )
        );
        this.fasterSpinnerQuantity.setValueFactory(
                new IntegerSpinnerValueFactory(1, 100, 1)
        );
        this.fasterSpinnerPrize.setValueFactory(
                new IntegerSpinnerValueFactory(0, Integer.MAX_VALUE, 1)
        );
     ...
     * {@link #textFieldISBN}, {@link #comboBoxAuthor}, {@link #fasterSpinnerGenre},
     * {@link #fasterSpinnerPrize} a {@link #fasterSpinnerQuantity}. Potom je provedena
    ...
    private void addBook(ActionEvent event) {
        ...
        CheckValue.checkSpinner(
                this.fasterSpinnerGenre, this.imageViewStatusGenre, "žánr",
                errors
        );
        CheckValue.checkSpinner(
                this.fasterSpinnerPrize, this.imageViewStatusPrize, "cena",
                errors
        );
        CheckValue.checkSpinner(
                this.fasterSpinnerQuantity, this.imageViewStatusQuantity,
                "počet", errors
        );
        ...
        if (errors.isEmpty()) {
            this.books.add(
                    new Book(
                            ...
                            this.fasterSpinnerGenre.getValue(),
                            this.textFieldISBN.getText(),
                            this.fasterSpinnerQuantity.getValue(),
                            this.fasterSpinnerPrize.getValue()
                    )
            );
            this.updateListView();
        } else {
