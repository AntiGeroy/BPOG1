...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        pieChart.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, null, new BorderWidths(1))));
    ...
    private void addEntry() {
        ...
        if (result.isPresent()){
            stringObservableList.add(result.get());
        }
